...
<body>
    ...
    <main id="main-content">
        <div class="container mt-5">
            <div class="jumbotron">
                <h1 class="display-4">KLIEN KAMI</h1>
                <hr class="my-4">
            </div>
        </div>
        ...
        <div class="card-deck">
        <div class="card">
            <img src="img/kominfo.png" class="card-img-top" alt="...">
    <div class="card-body">
  ...
  <div class="card">
    <img src="img/BNSP.png" class="card-img-top" alt="...">
    <div class="card-body">
  ...
  <div class="card">
    <img src="img/harapan.png" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
