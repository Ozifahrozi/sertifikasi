...
<body>
    ...
    <main id="main-content">
        <div class="container mt-5">
            <div class="jumbotron">
                <h1 class="display-4">PRODUK DAN JASA KAMI</h1>
                <hr class="my-4">
            </div>
        </div>
        ...
        <div class="card-deck">
  <div class="card">
    <img src="img/servis.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Jasa Servis Motor</h5>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Jasa Servis Mobil</h5>
      <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
    </div>
  </div>
  <div class="card">
    <img src="img/modif.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Jasa Modifikasi Kendaraan</h5>
